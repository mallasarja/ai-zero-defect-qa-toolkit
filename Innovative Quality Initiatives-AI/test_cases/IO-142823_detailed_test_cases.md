# IO-142823 — Enable Public Interface : Setup LogForwarder class and Enable Public methods for the component 
...
### Test Case ID
IO-142823-Backend-FUNC-Positive1
...
- Story context: Enable Public Interface : Setup LogForwarder class and Enable Public methods for the component 
...
### Test Case ID
IO-142823-Backend-FUNC-Negative1
...
### Test Case ID
IO-142823-Backend-REG-Positive1
...
### Test Case ID
IO-142823-Backend-REG-Negative1
...
### Test Case ID
IO-142823-Backend-NEG-Positive1
...
### Test Case ID
IO-142823-Backend-NEG-Negative1
...
### Test Case ID
IO-142823-Backend-MUNIT-Positive1
...
### Test Case ID
IO-142823-Backend-MUNIT-Negative1
...
### Test Case ID
IO-142823-Backend-INTEG-Positive1
...
### Test Case ID
IO-142823-Backend-INTEG-Negative1
...
### Test Case ID
IO-142823-Backend-API-Positive1
...
### Test Case ID
IO-142823-Backend-API-Negative1
...
### Test Case ID
IO-142823-Backend-PERF-Positive1
...
### Test Case ID
IO-142823-Backend-PERF-Negative1
...
### Test Case ID
IO-142823-Backend-SEC-Positive1
...
### Test Case ID
IO-142823-Backend-SEC-Negative1
...
### Test Case ID
IO-142823-Backend-SREL-Positive1
...
### Test Case ID
IO-142823-Backend-SREL-Negative1
...
### Test Case ID
IO-142823-Backend-E2E-Positive1
...
### Test Case ID
IO-142823-Backend-E2E-Negative1
...
### Test Case ID
IO-142823-Backend-COMP-Positive1
...
### Test Case ID
IO-142823-Backend-COMP-Negative1
...
### Test Case ID
IO-142823-Backend-ERR-Positive1
...
### Test Case ID
IO-142823-Backend-ERR-Negative1
