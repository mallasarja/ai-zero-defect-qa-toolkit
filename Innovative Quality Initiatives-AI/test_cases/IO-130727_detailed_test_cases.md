# IO-130727 — message-processing-common : Client configuration and version bump
...
### Test Case ID
IO-130727-Backend-FUNC-Positive1
...
- Story context: message-processing-common : Client configuration and version bump
...
### Test Case ID
IO-130727-Backend-FUNC-Negative1
...
### Test Case ID
IO-130727-Backend-REG-Positive1
...
### Test Case ID
IO-130727-Backend-REG-Negative1
...
### Test Case ID
IO-130727-Backend-NEG-Positive1
...
### Test Case ID
IO-130727-Backend-NEG-Negative1
...
### Test Case ID
IO-130727-Backend-MUNIT-Positive1
...
### Test Case ID
IO-130727-Backend-MUNIT-Negative1
...
### Test Case ID
IO-130727-Backend-INTEG-Positive1
...
### Test Case ID
IO-130727-Backend-INTEG-Negative1
...
### Test Case ID
IO-130727-Backend-API-Positive1
...
### Test Case ID
IO-130727-Backend-API-Negative1
...
### Test Case ID
IO-130727-Backend-PERF-Positive1
...
### Test Case ID
IO-130727-Backend-PERF-Negative1
...
### Test Case ID
IO-130727-Backend-SEC-Positive1
...
### Test Case ID
IO-130727-Backend-SEC-Negative1
...
### Test Case ID
IO-130727-Backend-SREL-Positive1
...
### Test Case ID
IO-130727-Backend-SREL-Negative1
...
### Test Case ID
IO-130727-Backend-E2E-Positive1
...
### Test Case ID
IO-130727-Backend-E2E-Negative1
...
### Test Case ID
IO-130727-Backend-COMP-Positive1
...
### Test Case ID
IO-130727-Backend-COMP-Negative1
...
### Test Case ID
IO-130727-Backend-ERR-Positive1
...
### Test Case ID
IO-130727-Backend-ERR-Negative1
