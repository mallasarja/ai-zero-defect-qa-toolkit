...
- Story context: [UI] Update behaviour of Path to records in HTTP response body and add First record contains headers checkbox
...
### Test Case ID
IO-141368-Backend-FUNC-Positive1
...
### Test Case ID
IO-141368-Backend-FUNC-Negative1
...
### Test Case ID
IO-141368-Backend-REG-Positive1
...
### Test Case ID
IO-141368-Backend-REG-Negative1
...
### Test Case ID
IO-141368-Backend-NEG-Positive1
...
### Test Case ID
IO-141368-Backend-NEG-Negative1
...
### Test Case ID
IO-141368-Backend-MUNIT-Positive1
...
### Test Case ID
IO-141368-Backend-MUNIT-Negative1
...
### Test Case ID
IO-141368-Backend-INTEG-Positive1
...
### Test Case ID
IO-141368-Backend-INTEG-Negative1
...
### Test Case ID
IO-141368-Backend-API-Positive1
...
### Test Case ID
IO-141368-Backend-API-Negative1
...
### Test Case ID
IO-141368-Backend-PERF-Positive1
...
### Test Case ID
IO-141368-Backend-PERF-Negative1
...
### Test Case ID
IO-141368-Backend-SEC-Positive1
...
### Test Case ID
IO-141368-Backend-SEC-Negative1
...
### Test Case ID
IO-141368-Backend-SREL-Positive1
...
### Test Case ID
IO-141368-Backend-SREL-Negative1
...
### Test Case ID
IO-141368-Backend-E2E-Positive1
...
### Test Case ID
IO-141368-Backend-E2E-Negative1
...
### Test Case ID
IO-141368-Backend-COMP-Positive1
...
### Test Case ID
IO-141368-Backend-COMP-Negative1
...
### Test Case ID
IO-141368-Backend-ERR-Positive1
...
### Test Case ID
IO-141368-Backend-ERR-Negative1
