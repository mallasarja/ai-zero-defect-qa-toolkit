# IO-142029 — Set Up Automated Alerts with Slack & Splunk Integration for Canary Metrics
...
### Test Case ID
IO-142029-Backend-FUNC-Positive1
...
- Story context: Set Up Automated Alerts with Slack & Splunk Integration for Canary Metrics
...
### Test Case ID
IO-142029-Backend-FUNC-Negative1
...
### Test Case ID
IO-142029-Backend-REG-Positive1
...
### Test Case ID
IO-142029-Backend-REG-Negative1
...
### Test Case ID
IO-142029-Backend-NEG-Positive1
...
### Test Case ID
IO-142029-Backend-NEG-Negative1
...
### Test Case ID
IO-142029-Backend-MUNIT-Positive1
...
### Test Case ID
IO-142029-Backend-MUNIT-Negative1
...
### Test Case ID
IO-142029-Backend-INTEG-Positive1
...
### Test Case ID
IO-142029-Backend-INTEG-Negative1
...
### Test Case ID
IO-142029-Backend-API-Positive1
...
### Test Case ID
IO-142029-Backend-API-Negative1
...
### Test Case ID
IO-142029-Backend-PERF-Positive1
...
### Test Case ID
IO-142029-Backend-PERF-Negative1
...
### Test Case ID
IO-142029-Backend-SEC-Positive1
...
### Test Case ID
IO-142029-Backend-SEC-Negative1
...
### Test Case ID
IO-142029-Backend-SREL-Positive1
...
### Test Case ID
IO-142029-Backend-SREL-Negative1
...
### Test Case ID
IO-142029-Backend-E2E-Positive1
...
### Test Case ID
IO-142029-Backend-E2E-Negative1
...
### Test Case ID
IO-142029-Backend-COMP-Positive1
...
### Test Case ID
IO-142029-Backend-COMP-Negative1
...
### Test Case ID
IO-142029-Backend-ERR-Positive1
...
### Test Case ID
IO-142029-Backend-ERR-Negative1
