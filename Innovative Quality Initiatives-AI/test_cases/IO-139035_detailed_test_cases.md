# IO-139035 — [BE] resolve baseURI handlebars on list connections page 
...
### Test Case ID
IO-139035-Backend-FUNC-Positive1
...
- Story context: [BE] resolve baseURI handlebars on list connections page 
...
### Test Case ID
IO-139035-Backend-FUNC-Negative1
...
### Test Case ID
IO-139035-Backend-REG-Positive1
...
### Test Case ID
IO-139035-Backend-REG-Negative1
...
### Test Case ID
IO-139035-Backend-NEG-Positive1
...
### Test Case ID
IO-139035-Backend-NEG-Negative1
...
### Test Case ID
IO-139035-Backend-MUNIT-Positive1
...
### Test Case ID
IO-139035-Backend-MUNIT-Negative1
...
### Test Case ID
IO-139035-Backend-INTEG-Positive1
...
### Test Case ID
IO-139035-Backend-INTEG-Negative1
...
### Test Case ID
IO-139035-Backend-API-Positive1
...
### Test Case ID
IO-139035-Backend-API-Negative1
...
### Test Case ID
IO-139035-Backend-PERF-Positive1
...
### Test Case ID
IO-139035-Backend-PERF-Negative1
...
### Test Case ID
IO-139035-Backend-SEC-Positive1
...
### Test Case ID
IO-139035-Backend-SEC-Negative1
...
### Test Case ID
IO-139035-Backend-SREL-Positive1
...
### Test Case ID
IO-139035-Backend-SREL-Negative1
...
### Test Case ID
IO-139035-Backend-E2E-Positive1
...
### Test Case ID
IO-139035-Backend-E2E-Negative1
...
### Test Case ID
IO-139035-Backend-COMP-Positive1
...
### Test Case ID
IO-139035-Backend-COMP-Negative1
...
### Test Case ID
IO-139035-Backend-ERR-Positive1
...
### Test Case ID
IO-139035-Backend-ERR-Negative1
