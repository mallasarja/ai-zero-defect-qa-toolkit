# IO-141753 — Update pipeline to create releases directly in the agent repository
...
### Test Case ID
IO-141753-Backend-FUNC-Positive1
...
- Story context: Update pipeline to create releases directly in the agent repository
...
### Test Case ID
IO-141753-Backend-FUNC-Negative1
...
### Test Case ID
IO-141753-Backend-REG-Positive1
...
### Test Case ID
IO-141753-Backend-REG-Negative1
...
### Test Case ID
IO-141753-Backend-NEG-Positive1
...
### Test Case ID
IO-141753-Backend-NEG-Negative1
...
### Test Case ID
IO-141753-Backend-MUNIT-Positive1
...
### Test Case ID
IO-141753-Backend-MUNIT-Negative1
...
### Test Case ID
IO-141753-Backend-INTEG-Positive1
...
### Test Case ID
IO-141753-Backend-INTEG-Negative1
...
### Test Case ID
IO-141753-Backend-API-Positive1
...
### Test Case ID
IO-141753-Backend-API-Negative1
...
### Test Case ID
IO-141753-Backend-PERF-Positive1
...
### Test Case ID
IO-141753-Backend-PERF-Negative1
...
### Test Case ID
IO-141753-Backend-SEC-Positive1
...
### Test Case ID
IO-141753-Backend-SEC-Negative1
...
### Test Case ID
IO-141753-Backend-SREL-Positive1
...
### Test Case ID
IO-141753-Backend-SREL-Negative1
...
### Test Case ID
IO-141753-Backend-E2E-Positive1
...
### Test Case ID
IO-141753-Backend-E2E-Negative1
...
### Test Case ID
IO-141753-Backend-COMP-Positive1
...
### Test Case ID
IO-141753-Backend-COMP-Negative1
...
### Test Case ID
IO-141753-Backend-ERR-Positive1
...
### Test Case ID
IO-141753-Backend-ERR-Negative1
